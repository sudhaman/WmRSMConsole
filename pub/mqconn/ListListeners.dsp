...
<html>
    ...
    <body onLoad="setNavigation('ListListeners.dsp', '%value encode(javascript) helpsys%', 'foo');showHideFilterCriteria('searchListenerName');">
            ...
            <tr>
                <td colspan=2>
                    <ul>
                        ...
                        <li>
				            <a href="/WmRSMConsole/mqconn/ListListeners.dsp?&adapterTypeName=%value -urlencode adapterTypeName%&action=suspendAllEnabled">
            				    Suspend all enabled</a>
                         </li>
                         <li>
                             <a href="/WmRSMConsole/mqconn/ListListeners.dsp?&adapterTypeName=%value -urlencode adapterTypeName%&action=enableAllSuspended">
                                 Enable all suspended</a>
                         </li>
                         <li id="showfew" name="showfew"><a href="javascript:showFilterPanel(true)">Filter Listeners</a></li>
                	 <li style="display:none" id="showall" name="showall"><a href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&dspName=.LISTLISTENERS">Show All Listeners</a></li>
        ...
        <td colspan=8 align="right">
            ...
            <tr>
                <td class="oddcol-l">Listener Name<a id="ascLN" href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&sort=LN&dspName=.LISTLISTENERS"><img border="0" style="float: middle" src="images/arrow_up.gif" width="15" height="15"></a>
            		<a id="desLN" href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&sort=LN&DES=true&dspName=.LISTLISTENERS"><img border="0" src="images/arrow_down.gif" style="float: middle" width="15" height="16"></a></td>
                <td class="oddcol-l">Package Name<a id="ascPN" href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&sort=PN&dspName=.LISTLISTENERS"><img border="0" style="float: middle" src="images/arrow_up.gif" width="15" height="15"></a>
            		<a id="desPN" href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&sort=PN&DES=true&dspName=.LISTLISTENERS"><img border="0" src="images/arrow_down.gif" style="float: middle" width="15" height="16"></a></td>
                <td class="oddcol">State<a id="ascState" href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&sort=State&dspName=.LISTLISTENERS"><img border="0" style="float: middle" src="images/arrow_up.gif" width="15" height="15"></a>
            		<a id="desState" href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&sort=State&DES=true&dspName=.LISTLISTENERS"><img border="0" src="images/arrow_down.gif" style="float: middle" width="15" height="16"></a></td>
                    ...
                    %loop listenerDataList%
                        <tr>
                            ...
                            <script>writeTD('rowdata');</script>
                                ...
                                %case 'enabled'%
                                	<SELECT ONCHANGE="window.location.href='/WmRSMConsole/mqconn/ListListeners.dsp?listenerNodeName=%value -urlencode listenerNodeName%&searchListenerName=%value -urlencode searchListenerName%&adapterTypeName=%value -urlencode ../adapterTypeName%&action='+ 
                            ...
                            <script>writeTD('rowdata');</script>
                                ...
                                %case 'disabled'%
                                    %ifvar lastError%
                                        <a href="/WmRSMConsole/mqconn/ListenerDetails.dsp?readOnly=true&adapterTypeName=%value -urlencode ../adapterTypeName%&listenerNodeName=%value -urlencode listenerNodeName%">Failed</font></a>
                                    %else%
                                        Succeeded
                                    %endif%
                                    </td>
                            ...
                            <script>writeTD('rowdata');</script>
                                %switch listenerEnabled%
                                %case 'enabled'%
                                    <img src="/WmRSMConsole/mqconn/icons/disabled_edit.gif" alt="Edit" border=0>
                                %case 'enablePending'%
                                    <img src="/WmRSMConsole/mqconn/icons/disabled_edit.gif" alt="Edit" border=0>
                                %case 'suspended'%
                                    <a href="/WmRSMConsole/mqconn/ListenerDetails.dsp?readOnly=some&adapterTypeName=%value -urlencode ../adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                                        <img src="/WmRSMConsole/mqconn/icons/config_edit.gif" alt="Edit" border=0></a>
                                %case 'suspendPending'%
                                    <a href="/WmRSMConsole/mqconn/ListenerDetails.dsp?readOnly=some&adapterTypeName=%value -urlencode ../adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                                        <img src="/WmRSMConsole/mqconn/icons/config_edit.gif" alt="Edit" border=0></a>
                                %case%
                                    <a href="/WmRSMConsole/mqconn/ListenerDetails.dsp?readOnly=false&adapterTypeName=%value -urlencode ../adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                                        <img src="/WmRSMConsole/mqconn/icons/config_edit.gif" alt="Edit" border=0></a>
                                %endswitch%
                            </td>

                            <script>writeTD('rowdata');</script>
                                <a href="/WmRSMConsole/mqconn/ListenerDetails.dsp?readOnly=true&adapterTypeName=%value -urlencode ../adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                                    <img src="/WmRoot/icons/file.gif" alt="View" border=0>
                                </a></td>

                            <script>writeTD('rowdata');</script>
                                <a href="/WmRSMConsole/mqconn/CopyListener.dsp?readOnly=false&adapterTypeName=%value -urlencode ../adapterTypeName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                                    <img src="/WmRSMConsole/mqconn/icons/copy.gif" alt="Copy" border=0>
                                </a></td>

                            <script>writeTD('rowdata'); swapRows();</script>
                                %ifvar listenerEnabled equals('disabled')%
                                    <a href="/WmRSMConsole/mqconn/ListListeners.dsp?action=deleteListener&%&adapterTypeName=%value -urlencode ../adapterTypeName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS"
                                       onclick="return confirmDelete('%value listenerNodeName%');">
                                        <img src="/WmRoot/icons/delete.gif" alt="Delete" border=0>
                                    </a>
                                %else%
                                    <img src="/WmRSMConsole/mqconn/icons/delete_disabled.gif" alt="Disable Listener to Delete" border=0>
                                %endif%
                            </td>
                        </tr>
                    %endloop%
	...
	<div class="oddrowdata" id="goContainer" name="goContainer" style="display:none;padding-top=2mm;">
		...
		%else%		
        		<a href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&prev=true&dspName=.LISTLISTENERS">&laquo; Previous</a>&nbsp;<label style="color:#666666;font-weight:bold;text-align:inherit;">Page (1-
		...
		%endif%	
			...
			%ifvar pStart vequals(pageSize)%			
				<!-- Next -->
		%else%
			<a href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&prev=false&dspName=.LISTLISTENERS">Next &raquo;</a>
		%endif%		
	</div>
	...
	<div class="oddrowdata" id="paginationContainer" name="paginationContainer" style="display:;padding-top=2mm;">
        ...
        %ifvar pStart equals('1')%
	%else%
		<a href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&prev=true&dspName=.LISTLISTENERS">&laquo; Previous</a>              
	%endif%
	       %loop totalNosOfPages%
		%ifvar totalNosOfPages -notempty%           		
		<a href="/WmRSMConsole/mqconn/ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&pageNumber=%value -urlencode totalNosOfPages%&dspName=.LISTLISTENERS">
