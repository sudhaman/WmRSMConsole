                    ...
                    %loop listenerTypes%
                        <tr>
                            <script>writeTD('rowdata-l');</script>
                                <a href="/WmRSMConsole/mqconn/SetListenerProperties.dsp?adapterTypeName=%value -urlencode adapterTypeName%&listenerTypeName=%value -urlencode listenerTypeName%">%value listenerDisplay%</a>
                            </td>
