...
<table width="100%">  
    ...
    <TR>
        <td>
            <ul>
    		    <li>
                    <a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?&adapterTypeName=%value -urlencode adapterTypeName%&action=suspendAllEnabled">
		    	        Suspend all enabled</a>
		    	</li>
                <li>
                    <a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?&adapterTypeName=%value -urlencode adapterTypeName%&action=enableAllSuspended">
                ...
                <li style="display:none" id="showall" name="showall"><a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&dspName=.LISTPOLLINGNOTIFICATIONS">Show All Polling Notifications</a></li>
    ...
    <tr>
        <td class="oddcol-l">Notification Name<a id="ascNN" href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&sort=NN&dspName=.ListPollingNotifications"><img border="0" style="float: middle" src="images/arrow_up.gif" width="15" height="15"></a>
            <a id="desNN" href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&sort=NN&DES=true&dspName=.LISTPOLLINGNOTIFICATIONS"><img border="0" src="images/arrow_down.gif" style="float: middle" width="15" height="16"></a></td>
        <td class="oddcol-l">Package Name<a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&sort=PN&dspName=.LISTPOLLINGNOTIFICATIONS"><img border="0" src="images/arrow_up.gif" align="baseline" width="15" height="15"></a>
            <a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&sort=PN&DES=true&dspName=.LISTPOLLINGNOTIFICATIONS"><img border="0" src="images/arrow_down.gif" align="baseline" width="15" height="15"></a></td>        
        <td class="oddcol">State<a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&sort=State&dspName=.LISTPOLLINGNOTIFICATIONS"><img border="0" src="images/arrow_up.gif" align="baseline" width="15" height="15"></a>
            <a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&sort=State&DES=true&dspName=.LISTPOLLINGNOTIFICATIONS"><img border="0" src="images/arrow_down.gif" align="baseline" width="15" height="15"></a></td>
    ...
    %ifvar notificationDataList -notempty%
        %loop notificationDataList%
            ...
            %switch notificationEnabled%
	            %case 'yes'%
	              <SELECT ONCHANGE="window.location.href='/WmRSMConsole/mqconn/ListPollingNotifications.dsp?notificationEnabled=no&notificationNodeName=%value -urlencode notificationNodeName%&searchNotificationName=%value -urlencode searchNotificationName%&adapterTypeName=%value -urlencode ../adapterTypeName%&action='+ 
            ...
            %else%
                %ifvar notificationEnabled equals('pending')%
                    <img src="/WmRSMConsole/mqconn/icons/disabled_edit.gif" alt="Edit" border=0>
                %else%                             
                    <a href="/WmRSMConsole/mqconn/PollingNotificationDetails.dsp?readOnly=false&adapterTypeName=%value -urlencode ../adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&notificationNodeName=%value -urlencode notificationNodeName%&dspName=.LISTPOLLINGNOTIFICATIONDETAILS">
                    <img src="/WmRSMConsole/mqconn/icons/config_edit.gif" alt="Edit" border=0>
                %endif%
            %endif%
            ...
            %ifvar notificationEnabled equals('unsched')%
                <img src="/WmRSMConsole/mqconn/icons/view-disabled.gif" alt="View" border=0>
            %else%
                <a href="/WmRSMConsole/mqconn/PollingNotificationDetails.dsp?readOnly=true&adapterTypeName=%value -urlencode ../adapterTypeName%&notificationNodeName=%value -urlencode notificationNodeName%&searchNotificationName=%value -urlencode searchNotificationName%&dspName=.LISTPOLLINGNOTIFICATIONDETAILS">
            ...
            %ifvar notificationEvent equals('true')%
                <a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?eventaction=disablePublish&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&notificationNodeName=%value -urlencode notificationNodeName%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTPOLLINGNOTIFICATIONS"
            ...
            %else%
                <a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?eventaction=enablePublish&notificationNodeName=%value -urlencode notificationNodeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTPOLLINGNOTIFICATIONS"
	...
	<div class="oddrowdata" id="goContainer" name="goContainer" style="display:none;padding-top=2mm;">
		...
		%else%		
        		<a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&prev=true&dspName=.LISTPOLLINGNOTIFICATIONDETAILS">&laquo; Previous</a>&nbsp;<label style="color:#666666;font-weight:bold;text-align:inherit;">Page (1-
		...
		%ifvar pStart vequals(pageSize)%			
				<!-- Next -->
		%else%
			<a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&prev=false&dspName=.LISTPOLLINGNOTIFICATIONDETAILS">Next &raquo;</a>
		%endif%		
	</div>
	...
	%ifvar pStart equals('1')%
	%else%
		<a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&prev=true&dspName=.LISTPOLLINGNOTIFICATIONDETAILS">&laquo; Previous</a>              
	%endif%
	       %loop totalNosOfPages%
		%ifvar totalNosOfPages -notempty%           		
			<a href="/WmRSMConsole/mqconn/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&pageNumber=%value -urlencode totalNosOfPages%&dspName=.LISTPOLLINGNOTIFICATIONDETAILS">
