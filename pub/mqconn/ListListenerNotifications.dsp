...
<table width="100%">  
    ...
    <tr>
                <td colspan=2>
                    <ul>
                	 ...
                	 <li style="display:none" id="showall" name="showall"><a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&dspName=.LISTLISTENERNOTIFICATIONS">Show All Listener Notifications</a></li>
    ...
    %ifvar notificationDataList -notempty%
		...
		%case 'yes'%
			...
			function callback(val,nodeID){      	    
				...
				<link rel="stylesheet" type="text/css" href="/WmRSMConsole/mqconn/subUserLookup.css" />
				<script type="text/javascript" src="/WmRSMConsole/mqconn/subUserLookup.js"></script>
				<a class="submodal" href="/WmRSMConsole/mqconn/subUserLookup.dsp?notificationNodeName=%value notificationNodeName%"><img border=0 align="bottom" src="/WmRoot/icons/magnifyglass.gif"/></a> 
				<!--  RUN AS USER SUB END-->	    	
			</td>
		    %endswitch%	    
                %case 'no'%
		...
		%endswitch%
            ...
            %switch notificationEnabled%
            %case 'yes'%
                <a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?action=disableNotification&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&notificationEnabled=yes&notificationNodeName=%value -urlencode notificationNodeName%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTLISTENERNOTIFICATIONS"
            ...
            %case 'no'%
                <a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?action=enableNotification&notificationEnabled=no&notificationNodeName=%value -urlencode notificationNodeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTLISTENERNOTIFICATIONS"
                 ONCLICK="return confirmEnable('%value notificationNodeName%');">       
                 <img src="/WmRoot/images/blank.gif" border=0 alt="Disabled">No</a></td>
            %case 'pending'%         
                <a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?action=forceNotification&notificationEnabled=no&notificationNodeName=%value -urlencode notificationNodeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTLISTENERNOTIFICATIONS"
            ...
            %ifvar notificationEvent equals('true')%
                <a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?eventaction=disablePublish&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&notificationEnabled=yes&notificationNodeName=%value -urlencode notificationNodeName%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTLISTENERNOTIFICATIONS"
            ...
            %else%
                <a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?eventaction=enablePublish&notificationEnabled=no&notificationNodeName=%value -urlencode notificationNodeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTLISTENERNOTIFICATIONS"
    ...
    %ifvar notificationDataList -notempty%
        %loop notificationDataList%
            ...
            %ifvar notificationEvent equals('true')%
                ...
                <img src="/WmRoot/images/green_check.gif" height=13 width=13 alt="Enabled" border=0>Yes
            %else%
                <a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?eventaction=enablePublish&notificationNodeName=%value -urlencode notificationNodeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTLISTENERNOTIFICATIONS"
                 ONCLICK="return confirmEventEnable('%value notificationNodeName%');">       
                 <img src="/WmRoot/images/blank.gif" border=0 alt="Disabled">No
            %endif%   
            </a></td>	
	...
	<div class="oddrowdata" id="goContainer" name="goContainer" style="display:none;padding-top=2mm;">
		...
		%else%		
        		<a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&prev=true&dspName=.LISTLISTENERNOTIFICATIONS">&laquo; Previous</a>&nbsp;<label style="color:#666666;font-weight:bold;text-align:inherit;">Page (1-
		...
		%endif%	
			...
			%ifvar pStart vequals(pageSize)%			
				<!-- Next -->
		%else%
			<a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&prev=false&dspName=.LISTLISTENERNOTIFICATIONS">Next &raquo;</a>
		%endif%		
	</div>
	...
	%ifvar pStart equals('1')%
	%else%
		<a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&prev=true&dspName=.LISTLISTENERNOTIFICATIONS">&laquo; Previous</a>              
	%endif%
	%loop totalNosOfPages%
		%ifvar totalNosOfPages -notempty%           		
		<a href="/WmRSMConsole/mqconn/ListListenerNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerNotificationName=%value -urlencode searchListenerNotificationName%&pageNumber=%value -urlencode totalNosOfPages%&dspName=.LISTLISTENERNOTIFICATIONS">
