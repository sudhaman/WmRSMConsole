...
<HTML>
    ...
    <form name="form" action="ListResources.dsp" method="POST">    
        ...
        <tr> 
            ...
            <td class="oddcol-l">Package Name<a href="/WmRSMConsole/mqconn/ListResources.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchConnectionName=%value -urlencode searchConnectionName%&sort=PN&dspName=.LISTRESOURCES"><img border="0" src="images/arrow_up.gif" align="baseline" width="15" height="15"></a>
            ...
            <td class="oddcol-l">Connection Type<a href="/WmRSMConsole/mqconn/ListResources.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchConnectionName=%value -urlencode searchConnectionName%&sort=CT&dspName=.LISTRESOURCES"><img border="0" src="images/arrow_up.gif" align="baseline" width="15" height="15"></a>
            ...
            <td class="oddcol-l">Enabled<a href="/WmRSMConsole/mqconn/ListResources.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchConnectionName=%value -urlencode searchConnectionName%&sort=EN&dspName=.LISTRESOURCES"><img border="0" src="images/arrow_up.gif" align="baseline" width="15" height="15"></a>
            ...
            %loop connDataNode%
                ...
                <tr>
                    ...
                    %switch connectionState%
                        %case 'enabled'%
                            <script>writeTD('rowdata');</script>
                                <a href="javascript:submitURL('/WmRSMConsole/mqconn/ListResources.dsp?action=enableConnection&connectionState=disabled&adapterTypeName=%value -urlencode ../adapterTypeName%&connectionAlias=%value -urlencode connectionAlias%&dspName=.LISTRESOURCES')"
			           ONCLICK="return confirmDisable('%value connectionAlias%');">
                        ...
                        %case 'shuttingdown'%
                            <script>writeTD('rowdata');</script>
                                <a href="/WmRSMConsole/mqconn/ListResources.dsp?action=enableConnection&connectionAlias=%value -urlencode connectionAlias%&connectionState=shuttingdown&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTRESOURCES"
			           ONCLICK="return confirmEnable('%value connectionAlias%');">
                        ...
                        %case 'disabled'%
                            <script>writeTD('rowdata');</script>
	                        <a href="javascript:submitURL('/WmRSMConsole/mqconn/ListResources.dsp?action=enableConnection&connectionState=enabled&adapterTypeName=%value -urlencode ../adapterTypeName%&connectionAlias=%value -urlencode connectionAlias%&dspName=.LISTRESOURCES')"
			           ONCLICK="return confirmEnable('%value connectionAlias%');">
                    ...
                    %ifvar connectionState equals('disabled')%
                        <script>writeTD('rowdata');</script>
                            <a href="/WmRSMConsole/mqconn/ConnNodeDetails.dsp?readOnly=false&connectionAlias=%value -urlencode connectionAlias%&adapterTypeName=%value -urlencode ../adapterTypeName%&searchConnectionName=%value -urlencode ../searchConnectionName%">
                                <img src="/WmRSMConsole/mqconn/icons/config_edit.gif" alt="Edit" border=0>
                            </a>
                        </td>
                    %else%
                        <script>writeTD('rowdata');</script>
                            <img src="/WmRSMConsole/mqconn/icons/disabled_edit.gif" alt="Disable Connection to Edit" border=0>
                        </td>
                    %endif%
	    
                    <script>writeTD('rowdata');</script>
                        <a href="/WmRSMConsole/mqconn/ConnNodeDetails.dsp?readOnly=true&connectionAlias=%value -urlencode connectionAlias%&adapterTypeName=%value -urlencode ../adapterTypeName%&searchConnectionName=%value -urlencode ../searchConnectionName%">
                    ...
                    <script>writeTD('rowdata');</script>
                        ...
                        <a href="/WmRSMConsole/mqconn/CopyConnection.dsp?readOnly=false&connectionAlias=%value -urlencode connectionAlias%&adapterTypeName=%value -urlencode ../adapterTypeName%&searchConnectionName=%value -urlencode ../searchConnectionName%">
                    ...
                    <script>writeTD('rowdata');swapRows();</script>
                        %ifvar connectionState equals('disabled')%
                            <a href="/WmRSMConsole/mqconn/ListResources.dsp?action=deleteConnection&connectionAlias=%value -urlencode connectionAlias%&adapterTypeName=%value -urlencode ../adapterTypeName%&dspName=.LISTRESOURCES"
                               ONCLICK="return confirmDelete('%value connectionAlias%');">
                                <img src="/WmRoot/icons/delete.gif" alt="Delete" border=0>
                            </a>
                        %else%
                            <img src="/WmRSMConsole/mqconn/icons/delete_disabled.gif" alt="Disable Connection to Delete" border=0>
                        %endif%
                    </td>
                </tr>
            %endloop%
